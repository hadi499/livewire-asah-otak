    ...
    <div>
        <form wire:submit.prevent="createPage" enctype="multipart/form-data" class="w-full md:w-[600px] border p-4">
            ...
            <div class="mb-4" wire:ignore>
                ...
                <textarea id="mycontent" rows="4" cols="50" class="mt-1 block w-full border p-2"></textarea>
            ...
            <div class="mb-4" wire:ignore>
                ...
                <textarea id="mycontent2" wire:model="indonesian" class="mt-1 block w-full border p-2" rows="4"
                    cols="50"></textarea>
